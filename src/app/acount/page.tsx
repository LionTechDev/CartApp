			...
			<div className="max-w-3xl mx-auto space-y-12">
				...
				<section className="space-y-8">
					...
					<div className="grid gap-6 md:grid-cols-2">
						<Input placeholder="Usuario" className="bg-white border-gray-200" />
						<Input
							type="password"
				...
				<section className="space-y-8">
					...
					<div className="grid gap-6 md:grid-cols-2">
						...
						<Input
							...
							className="bg-white border-gray-200"
						/>
						<Input placeholder="País" className="bg-white border-gray-200" />
						<Input
							placeholder="Provincia"
							className="bg-white border-gray-200"
						/>
						<Input placeholder="Ciudad" className="bg-white border-gray-200" />
						<Input
								...
								<ScrollArea className="h-[60vh] pr-4">
									<Tabs defaultValue="weekdays" className="w-full">
										<TabsList className="grid w-full grid-cols-2 mb-6">
											<TabsTrigger value="weekdays" className="text-sm">
												Lunes a Viernes
											</TabsTrigger>
											<TabsTrigger value="weekend" className="text-sm">
												Fin de Semana
											</TabsTrigger>
										</TabsList>
										<TabsContent value="weekdays" className="space-y-6">
											{[
												"Lunes",
												"Martes",
												"Miércoles",
